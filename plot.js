var plugin = new function() {
    ...
    this.drawTH2bins = function(main, hist, plot) {
        ...
        .attr("width",function(d,i,j) {
          if(j==1 || j==3 || j==5 || j==12 || j==14 || j==16)
            return plot.x.scale(2*plot.bins.lowEdgeX(i+1)) - plot.x.scale(2*plot.bins.lowEdgeX(i));
          return plot.x.scale(plot.bins.lowEdgeX(i+1)) - plot.x.scale(plot.bins.lowEdgeX(i));
        })
